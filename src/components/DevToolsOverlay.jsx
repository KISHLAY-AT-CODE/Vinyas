                ...
                <div className="fixed inset-0 z-[120] flex justify-end bg-black/40 backdrop-blur-xs animate-in fade-in duration-200" onClick={() => setIsOpen(false)}>
                    ...
                    >
                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar">
                            ...
                            {/* Page Loading Sandbox */}
                            <div className="bg-slate-900/80 rounded-2xl border border-slate-800 p-4 space-y-3">
                                <h4 className="text-xs font-bold text-slate-400 uppercase tracking-widest flex items-center gap-1.5">
                                    <i className="ph-bold ph-spinner-gap text-teal-400 text-sm"></i> Page Loading Sandbox
                                </h4>
                                <p className="text-[10px] text-slate-500 leading-normal font-medium font-sans">
                                    Test the custom page transition loading screen with a 2-second simulation.
                                </p>
                                <button
                                    onClick={triggerPageLoading}
                                    className="w-full py-2.5 bg-teal-500/10 hover:bg-teal-500 hover:text-white border border-teal-500/30 text-teal-400 font-black text-xs rounded-xl shadow-lg transition-all flex items-center justify-center gap-1.5 cursor-pointer"
                                >
                                    <i className="ph-bold ph-play text-sm"></i> Test Loading Animation (2s)
                                </button>
                            </div>
